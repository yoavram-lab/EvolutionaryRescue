...
Notably, the latter indicates that aneuploidy, even when it only provides tolerance, increases the probability that the tumor will be rescued, as long as it occurs frequently enough (\Cref{rescue_prob}A, \cref{eq:N_ratio}).  
