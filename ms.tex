...
In some of the analysis, we consider breast cancer. 
\citet{salehi2021clonal} studied multiple TNBC PDX clones (triple-negative breast cancer patient-derived xenografts).
Their results suggest that aneuploidy and other copy number alterations provid resistance to the drug cisplatin.  
Thus, we assume that aneuploid breast cancer cells are are partially or even completely resistant, i.e., $\Delta_m \ge \Delta_a > 0$, and that the division and death rates of aneuploid cells in the presence of cisplatin is the same as those of  sensitive breast cancer cells in the absence of the drug. 
The growth rate of breast cancer cells in the absence of drug is $0.0085$ per day \citep{spratt1996rates}.
The doubling time of breast cancer cells in the absence of cellular death is 8.2 days \citep{rew2000cell}.
Thus, the division rate of aneuploid cells is $\lambda_a=\log{(2)}/8.2=0.0845$ per day, and their death rate is $\mu_a=0.076$ per day.
To determine the division and death rates of sensitive cells, we chose TNBC-SA535 clone H from \citet{salehi2021clonal}, which has a relative fitness of $\approx 1.011$. Thus, the selection coefficient is the ratio of the aneuploid and sensitive Wrightian fitness values minus 1 \citep{chevin2011measuring}. The Malthusian fitness is the log of the Wrightian fitness \citep{Wu2013a}. Thus, $\Delta_s = \log{0.9975} -0.0025$. 
...
A similar analysis for TNBC-SA609 clone A and TNBC-SA1035 clone H from \citet{salehi2021clonal} gives $\lambda_s=0.08, \mu_s=0.12$ and $\lambda_s=0.08, \mu=0.1$, respectively. % TODO it does not make sense that when you change aneuploid clones what changes is the sensitive growth rate - the sensitive growth rate should be constant and the aneuploid clone growth rate should change...
...
Although this may seem like a small region of parameter space in a general model of evolutionary rescue (Fig.~\ref{rescue_threshold}A, inset), it could be biologically significant for some tumor under specific drug therapies.
