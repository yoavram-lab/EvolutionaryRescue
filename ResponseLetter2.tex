...
\textcolor{blue}{We added (line 124): ``We define tolerant cells as those that survive drug exposure longer than susceptible cells, while resistant cells require higher drug concentrations to be affected. For details on these distinctions, see Brauner et al. (2016).''} %Change S17
...
\textcolor{blue}{Line 477: We changed "rapidly" to "easily" because $\tau_m<\tau_a$ is conditioned on evolutionary rescue and the word "rapidly" may suggest that aneuploidy speeds up the process of rescue, which is incorrect. }%Change RS1}

\textcolor{blue}{Line 397: Recurrence time is an increasing function of sensitive and aneuploid growth rates, not a decreasing function}%. Change RS2}

\textcolor{blue}{Line 134 typo: "anuploids"$\rightarrow$"aneuploids".} % Change RS3}

\textcolor{blue}{Line 111 typo: "aneuplidies"$\rightarrow$"aneuploids".}% Change RS4}

\textcolor{blue}{Line 300: We have corrected the interpretation of $\abs{\Delta_a}/u\lambda_a$. It is the ratio of the number of sensitive births required to produce an aneuploid, $1/u$, to the number of births in the resulting aneuploid lineage before it goes extinct, $\lambda_a / |\Delta_a|$.}% Change RS5}
