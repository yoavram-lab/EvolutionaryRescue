...
\textcolor{blue}{We added (line 124): ``We define tolerant cells as those that survive drug exposure longer than sensitive cells, while resistant cells require higher drug concentrations to be affected. For details on these distinctions, see Brauner et al. (2016).''} %Change S17
