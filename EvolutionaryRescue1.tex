...
Because these results are scattered across multiple papers, and because they all follow easily from simple branching process approximations, we re-derive all results here within our single cancer model.
...
% NOTE FROM DANIEL: I cut this paragraph because I think it's implicitly based on a uniform distribution of aneuploid growth rates. But the whole point of why we're doing this is because there are apparently some interesting aneuploidies that have growth rates near 0
