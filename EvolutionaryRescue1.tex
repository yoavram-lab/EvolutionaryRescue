...
\end{aligned}
\end{equation}
\cref{eq:N_a} is basically our model's equivalent of \citet{iwasa2004evolutionary}'s eq.~A3, or eq.~8 of \citet{osmond_genetic_2020} with the distribution of fitness effects set to a delta function. %change 57
