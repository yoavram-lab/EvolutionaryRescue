...
We validate these approximations by comparing them to results of stochastic evolutionary simulations. We find that the approximations work very well (\Cref{rescue_prob_wt_growth_small_N,rescue_prob_wt_growth_large_N,rescue_prob_an_growth_small_N,rescue_prob_an_growth_large_N,rescue_prob_N_nongrow,rescue_prob_N_logistic}).
...
\label{rescue_prob_wt_growth_small_N}
\end{figure}
%%%%%%%%%%%
\begin{figure}[p]
