...
\daniel{I think this section has too much of the mathematical derivations, which should instead be in something like Methods. It should focus on just the results.}
...
To analyze evolutionary rescue in this model, we use the framework of \emph{multitype branching processes} \citep{harris1963theory}. 
