...
We validate these approximations by comparing them to results of stochastic evolutionary simulations. We find that the approximations work very well (\Cref{rescue_prob_wt_growth_small_large_N,rescue_prob_an_growth_small_N,rescue_prob_an_growth_large_N,rescue_prob_N_nongrow,rescue_prob_N_logistic}).
...
\end{subfigure}
\caption{
\textbf{Evolutionary rescue probability increases with wildtype and aneuploid growth rates.}
Reduce probability is very high when aneuploidy provides partial resistance, in an initially small tumor (\textbf{Aleft}, $N=10^4$) and even more so in an initially large tumor (\textbf{Aright}, $N=10^8$). % TODO change panel labels to ABCD
When aneuploidy provides tolerance (\textbf{Bleft}, $N=10^4$; (\textbf{Bright}, $N=10^8$), the rescue probability is much lower. However, in all cases rescue probability increase with both the wildtype growth rate (x-axis) and the aneuploidy growth rate (colors).
...
% TODO add parameter valuesEvolutionaryRescue1.tex
}
...
\label{rescue_prob_wt_growth_small_large_N}
\end{figure}
%%%%%%%%%%%
%\begin{figure}[p]
...
%\label{rescue_prob_wt_growth_large_N}
%\end{figure}
%%%%%%%%%%%
\begin{figure}[p]
% small population size
...
\label{rescue_prob_an_growth_small_N}
\end{figure}
%%%%%%%%%%%
\begin{figure}[p]
% large population size
...
\label{rescue_prob_an_growth_large_N}
\end{figure}
%%%%%%%%%%%
\begin{figure}[p]
