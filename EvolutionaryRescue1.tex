...
$f_1(t) = \frac{R\left(t\right)\e^{-\int_0^{t} R(z)\d z}}{p_{rescue}}$. % Todo is this correct? I made changes
...
\end{equation}
% YOAV HERE - dont understand how the previous two lines are the same...
