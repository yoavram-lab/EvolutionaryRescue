...
\draw [,color=blue,thick](-0.7+10,-1.25+2-4) -- (-0.7+10,-2.75+2-4);

\draw [thick](0.05+5,-1.25+2-8) -- (0.05+5,-2.75+2-8);
\draw [,color=blue,thick](-0.55+5,-1.25+2-8) -- (-0.55+5,-2.75+2-8);
%\draw [thick](-0.55+5,-1.25-2) -- (-0.55+5,-2.75-2);
...
\begin{equation*}
\mathcal{P}\left(z,t\right)=\sum_{i=0}^\infty p_i\left(t\right)z^i \quad\text{and}\quad p_i\left(t\right)=\left.\frac{1}{i!}\frac{\partial^i\mathcal{P}}{\partial z^i}\right|_{z=0}
\end{equation*}
